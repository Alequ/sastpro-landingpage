              ...
              <div className="space-y-4 lg:col-span-2 ">
                ...
                <div className="space-y-4">
                  <p
                    ...
                    style={{ fontFamily: "var(--font-montserrat)" }}
                  >
                    SASTpro is S.A.S Transition’s in-house digital platform - a
                    powerful safety and asset management system connecting
                    people, permits, and performance. It replaces spreadsheets,
                    paper permits, and guesswork with real-time control and
                    visibility.
                  </p>
                </div>
              </div>
