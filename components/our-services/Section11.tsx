              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <p
                    ...
                    style={{ fontFamily: "var(--font-montserrat)" }}
                  >
                    S.A.S Transition provides 24/7 callout coverage and
                    technical response teams to diagnose, repair, and restore
                    systems safely and efficiently. Our engineers combine deep
                    experience with live digital oversight through SASTpro,
                    ensuring every action is controlled and traceable.
                  </p>
                </div>
              </div>
