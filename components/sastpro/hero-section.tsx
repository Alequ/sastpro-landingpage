      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-8 flex flex-col items-center justify-center gap-1">
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                <div className="text-lg font-bold text-[#D4AF37] tracking-wide">
                  S.A.S TRANSITION
                </div>
                <div className="text-[10px] text-muted-foreground tracking-wider">
                  SAST TRANSITION ENGINEERING & SERVICES
                </div>
              </div>
            </div>
          </div>
          ...
          <p className="mt-6 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg max-w-2xl mx-auto">
            Lorem ipsum dolor sit amet, consectetuer adipiscin elit, sed diam
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <Button
              size="lg"
              className="text-base bg-[#D4AF37] hover:bg-[#B8941F] text-black font-semibold"
            >
              SASTpro
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="text-base bg-transparent border-white/30 hover:bg-white/10 text-white"
            >
              Data Centres
            </Button>
          </div>
